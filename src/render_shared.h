/* render_shared.h -- renderer structs crossing the CPU/GPU boundary, declared once.
 *
 * Included by C (the renderer, the demo, the cooker) and by GLSL (with
 ...
 * a struct in render_shared.h, seen identically by C and GLSL, with resources as
